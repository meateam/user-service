...
export const kartoffelCTSQuerySearch: string = `/search?domainusers.datasource=${process.env.USER_KARTOFFEL_CTS_DATASOURCE || 'dataSource1'}`;
...
export const phoneBookURL: string = `${process.env.PHONE_BOOK_URL || 'http://localhost'}:${process.env.PHONE_BOOK_PORT || '80'}`;
