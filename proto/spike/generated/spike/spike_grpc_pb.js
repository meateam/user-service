...
var spike_spike_pb = require('../spike/spike_pb.js');

function serialize_spike_GetSpikeTokenRequest(arg) {
  if (!(arg instanceof spike_spike_pb.GetSpikeTokenRequest)) {
...
function deserialize_spike_GetSpikeTokenRequest(buffer_arg) {
  return spike_spike_pb.GetSpikeTokenRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_spike_SpikeToken(arg) {
  if (!(arg instanceof spike_spike_pb.SpikeToken)) {
...
function deserialize_spike_SpikeToken(buffer_arg) {
  return spike_spike_pb.SpikeToken.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_spike_ValidateTokenResponse(arg) {
  if (!(arg instanceof spike_spike_pb.ValidateTokenResponse)) {
...
function deserialize_spike_ValidateTokenResponse(buffer_arg) {
  return spike_spike_pb.ValidateTokenResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_spike_ValidateTokenResquest(arg) {
  if (!(arg instanceof spike_spike_pb.ValidateTokenResquest)) {
...
function deserialize_spike_ValidateTokenResquest(buffer_arg) {
  return spike_spike_pb.ValidateTokenResquest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SpikeService = exports.SpikeService = {
  getSpikeToken: {
    ...
    requestType: spike_spike_pb.GetSpikeTokenRequest,
    responseType: spike_spike_pb.SpikeToken,
  ...
  validateToken: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: spike_spike_pb.ValidateTokenResquest,
    responseType: spike_spike_pb.ValidateTokenResponse,
