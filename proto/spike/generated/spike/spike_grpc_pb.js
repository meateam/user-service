...
function serialize_spike_ValidateTokenRequest(arg) {
  if (!(arg instanceof spike_spike_pb.ValidateTokenRequest)) {
...
function deserialize_spike_ValidateTokenRequest(buffer_arg) {
  return spike_spike_pb.ValidateTokenRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SpikeService = exports.SpikeService = {
  ...
  validateToken: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: spike_spike_pb.ValidateTokenRequest,
