...
goog.exportSymbol('proto.users.DomainUser', null, global);
 ...
 * @constructor
 */
proto.users.DomainUser = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.users.DomainUser, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.users.DomainUser.displayName = 'proto.users.DomainUser';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.users.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    domainuser: (f = msg.getDomainuser()) && proto.users.DomainUser.toObject(includeInstance, f)
  };
...
proto.users.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.users.DomainUser;
      reader.readMessage(value,proto.users.DomainUser.deserializeBinaryFromReader);
      msg.setDomainuser(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.users.User.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDomainuser();
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      proto.users.DomainUser.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional DomainUser domainUser = 8;
 * @return {?proto.users.DomainUser}
 */
proto.users.User.prototype.getDomainuser = function() {
  return /** @type{?proto.users.DomainUser} */ (
    jspb.Message.getWrapperField(this, proto.users.DomainUser, 8));
};


/**
 * @param {?proto.users.DomainUser|undefined} value
 * @return {!proto.users.User} returns this
*/
proto.users.User.prototype.setDomainuser = function(value) {
 ...
 * @return {!proto.users.User} returns this
 */
proto.users.User.prototype.clearDomainuser = function() {
  return this.setDomainuser(undefined);
};
 ...
 * @return {boolean}
 */
proto.users.User.prototype.hasDomainuser = function() {
 ...
 * @return {!Object}
 */
proto.users.DomainUser.prototype.toObject = function(opt_includeInstance) {
  return proto.users.DomainUser.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.users.DomainUser} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.users.DomainUser.toObject = function(includeInstance, msg) {
  var f, obj = {
    uniqueid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    adfsuid: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * @return {!proto.users.DomainUser}
 */
proto.users.DomainUser.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.users.DomainUser;
  return proto.users.DomainUser.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.users.DomainUser} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.users.DomainUser}
 */
proto.users.DomainUser.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.users.DomainUser.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.users.DomainUser.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.users.DomainUser} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.users.DomainUser.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.users.DomainUser.prototype.getUniqueid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.users.DomainUser} returns this
 */
proto.users.DomainUser.prototype.setUniqueid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string adfsUID = 2;
 * @return {string}
 */
proto.users.DomainUser.prototype.getAdfsuid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.users.DomainUser} returns this
 */
proto.users.DomainUser.prototype.setAdfsuid = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.users.DomainUser.prototype.getDatasource = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.users.DomainUser} returns this
 */
proto.users.DomainUser.prototype.setDatasource = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
