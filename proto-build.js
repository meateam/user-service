...
/**
 * getSpikeProto gets the proto file from the spike-service in github, and compiles it to javascript and typescript. The function should be called before compiling the typescript files.
...
async function getSpikeProto(fileName, protoPath) {
    try {
        ...
        await fs.promises.writeFile(`${protoPath}`, proto.data);
