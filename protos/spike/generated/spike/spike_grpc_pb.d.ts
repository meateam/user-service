...
interface ISpikeService_IValidateToken extends grpc.MethodDefinition<spike_spike_pb.ValidateTokenResquest, spike_spike_pb.ValidateTokenResponse> {
    path: string; // "/spike.Spike/ValidateToken"
    requestStream: boolean; // false
    responseStream: boolean; // false
    requestSerialize: grpc.serialize<spike_spike_pb.ValidateTokenResquest>;
    requestDeserialize: grpc.deserialize<spike_spike_pb.ValidateTokenResquest>;
...
export interface ISpikeServer {
    ...
    validateToken: grpc.handleUnaryCall<spike_spike_pb.ValidateTokenResquest, spike_spike_pb.ValidateTokenResponse>;
}
...
export interface ISpikeClient {
    ...
    validateToken(request: spike_spike_pb.ValidateTokenResquest, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
    validateToken(request: spike_spike_pb.ValidateTokenResquest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
    validateToken(request: spike_spike_pb.ValidateTokenResquest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
}
...
export class SpikeClient extends grpc.Client implements ISpikeClient {
    ...
    public validateToken(request: spike_spike_pb.ValidateTokenResquest, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
    public validateToken(request: spike_spike_pb.ValidateTokenResquest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
    public validateToken(request: spike_spike_pb.ValidateTokenResquest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: spike_spike_pb.ValidateTokenResponse) => void): grpc.ClientUnaryCall;
}
